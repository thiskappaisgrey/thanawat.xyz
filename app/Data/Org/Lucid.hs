...
-- | This file is copied from: https://github.com/fosskers/org-mode/blob/master/org-mode-lucid/lib/Data/Org/Lucid.hs
-- | So I can modify it to add classnames
...
data OrgStyle = OrgStyle
  { includeTitle    :: Bool
    ...
    -- of the document.
  , includeDate :: Bool
    -- ^ Whether to include the @#+DATE: ...@ value as an @<span>@ tag at the top
    -- of the document.
  , tableOfContents :: TOC
...
blockHTML os b = case b of
  ...
  Example t | otherwise    -> pre_ $ toHtml t
